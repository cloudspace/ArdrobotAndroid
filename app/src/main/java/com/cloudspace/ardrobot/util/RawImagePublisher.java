...
import com.cloudspace.ardrobot.util.custom_ros.CustomRawImageListener;
...
public class RawImagePublisher implements CustomRawImageListener {
    ...
    public RawImagePublisher(ConnectedNode connectedNode, int quality) {
        ...
        this.imagePublisher = connectedNode.newPublisher(Constants.NODE_IMAGE_COMPRESSED, CompressedImage._TYPE);
